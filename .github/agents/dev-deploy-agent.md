...
## Project Structure
-   **AppHost:** src/MoreSpeakers.AppHost/AppHost.cs - The entry point for orchestration.
-   **Database Scripts:** scripts/database/ - The SOURCE OF TRUTH for the schema.
-   **Infrastructure:** Azure Bicep / Docker files.
...
## Tools and Commands
-   **Start Aspire:** dotnet run --project src/MoreSpeakers.AppHost
