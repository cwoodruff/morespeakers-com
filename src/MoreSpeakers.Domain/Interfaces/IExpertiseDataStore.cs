...
{
    Task<Result<Expertise>> GetAsync(int primaryKey);
    Task<Result> DeleteAsync(int primaryKey);
    Task<Result> DeleteAsync(Expertise entity);
    Task<Result<Expertise>> SaveAsync(Expertise entity);
    Task<Result<List<Expertise>>> GetAllAsync();
